import pandas as pd
from ImportData import tuning_class_data
...
#Get data
x_train, y_train = tuning_class_data()
...
scores = ['f1_macro', 'precision_macro', 'recall_macro', 'roc_auc_ovo']
...
out.to_excel('Tunning/classification/random_search.xlsx')